class WeatherItem < ActiveRecord::Base
  ...
  def self.get_locations(zip_code)
    #this returns XML
    url = "http://A3436701355.api.wxbug.net/getStationsXML.aspx?ACode=A3436701355&zipCode=#{zip_code}"
  ...
  def self.get_live_weather(station_id)
    #This returns RSS
    url = "http://api.wxbug.net/getLiveWeatherRSS.aspx?ACode=A3436701355&stationid=#{station_id}&unittype=0"
